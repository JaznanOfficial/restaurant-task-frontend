...
const Home = () => {
    return (
        <div
            className="section flex items-center xl:justify-between justify-center flex-wrap"
            id="home"
        >
            <div className="flex flex-col items-center md:items-start justify-center gap-10">
                <div className="sm:text-[2.5rem] text-[1.8rem] font-bold text-center md:text-left">
